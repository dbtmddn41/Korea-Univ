> **Note:** This assignment is from the [ku-plrg-classroom/docs](https://github.com/ku-plrg-classroom/docs/tree/main/cose212/lfae) repository.
...
with **lazy evaluation**. This assignment implemented the `interp`
function.
